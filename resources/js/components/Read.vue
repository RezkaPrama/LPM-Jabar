  ...
  export default {
    ...
    methods: {
      loadData() {
        ...
        axios.get("http://localhost:8000/api/penerima-bansos").then(response => {
          // mengirim data hasil fetch ke varibale array datas
          this.datas = response.data;
        });
      },
      deleteData(id) {
        // delete data
        axios.delete("http://localhost:8000/api/penerima-bansos/" + id).then(response => {
          this.loadData();
        });
      }
    }
